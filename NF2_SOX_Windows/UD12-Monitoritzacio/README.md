...
![Performance Monitor](./images/UD12_02.png)

### Resource Monitor

És una eina que proporciona una informació similar a la que podeu obtenir amb l'opció de Performance del Task Manager.

![Resource Monitor](./images/UD12_03.png)
...
![Auditoria d'accés a objectes](./images/UD12_05.png)
...
![Visor d'esdeveniments](./images/UD12_06.png)
...
![Auditoria d'esborrat de fitxers GPO avançada 3](./images/UD12_11.png)
...
![Auditoria d'esborrat de fitxers GPO avançada 4](./images/UD12_12.png)

Si l’obrim podem veure tant l’usuari com l’objecte en concret que s’ha esborrat.

![Auditoria d'esborrat de fitxers GPO avançada 5](./images/UD12_13.png)
